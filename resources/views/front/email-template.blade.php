...
<body style="font-size:14px;font-weight:400;font-family:'Rubik', sans-serif;">
    <div class="container pt-5 pb-5">
        <div class="row">
            <div class="col-lg-12"><img class="mb-3" width="180" src="../../../../i.ibb.co/k69gLc3/logo.png" alt="logo">
            ...
            <div class="col-lg-12">
                ...
                <p style="font-size: 12px;">Thank you for ordering greeny. We offer a 7-day return policy on all
                    products. If you have any complain about this order, please call or email us. (VAT has been
                    calculated as per GO 02/Mushak/2019). This is a sytem generated invoice and no signature or seal is
                    required. </p>
            </div>
        </div>
    </div>
