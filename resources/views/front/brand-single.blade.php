...
@section('content')
    ...
    <div class="brand-single"><a href="#"><img src="{{ $brand->image }}" alt="brand"></a><a href="#">
            <h3>{{ $brand->name }}</h3>
        </a>
        <ul>
        ...
        <p>({{ $brand->vendor_products->count() }} items)</p>
    </div>
                        ...
                        <div class="product-card">
                            <div class="product-media">
                                <div class="product-label"><label
                                        class="label-text sale">{{ intval($product->discount) }}% off</label></div><button
                                    class="product-wish wish"><i class="fas fa-heart"></i></button><a
                                    class="product-image" href="product-video"><img src="{{ $product->image }}"
                                        alt="product"></a>
                            ...
                            <div class="product-content">
                                ...
                                <h6 class="product-price">
                                    ...
                                    @endif
                                    <span>
                                        {{ $product->price }}<small>/piece</small></span>
                                </h6><button class="product-add" title="Add to Cart"><i
