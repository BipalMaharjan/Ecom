        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="author-single">
                            <div class="author-content"><a href="#" class="author-image"><img
                            ...
                            <p class="author-bio">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea
                                deserunt nisi, tempore eveniet pariatur natus delectus commodi, totam est culpa
                                ducimus rem reprehenderit suscipit veritatis assumenda. Delectus, saepe. Explicabo,
                                quos magnam fuga porro </p>
                            <ul class="author-meta">
                                <li title="Total Blog"><i class="fab fa-readme"></i><span>Total Blog 25</span></li>
                                <li title="Total Comment"><i class="fas fa-comments"></i><span>Total Comment
                                        130</span></li>
                                <li title="Total Share"><i class="fas fa-share-alt"></i><span>Total Share 45</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="blog-card">
                            <div class="blog-media"><a class="blog-img" href="#"><img src="images/blog/05.jpg"
                                        alt="blog"></a></div>
                            <div class="blog-content">
                                <ul class="blog-meta">
                                    <li><i class="fas fa-user"></i><span>admin</span></li>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="blog-card">
                            <div class="blog-media"><a class="blog-img" href="#"><img src="images/blog/06.jpg"
                                        alt="blog"></a></div>
                            <div class="blog-content">
                                <ul class="blog-meta">
                                    <li><i class="fas fa-user"></i><span>admin</span></li>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="blog-card">
                            <div class="blog-media"><a class="blog-img" href="#"><img src="images/blog/07.jpg"
                                        alt="blog"></a></div>
                            <div class="blog-content">
                                <ul class="blog-meta">
                                    <li><i class="fas fa-user"></i><span>admin</span></li>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="blog-card">
                            <div class="blog-media"><a class="blog-img" href="#"><img src="images/blog/08.jpg"
                                        alt="blog"></a></div>
                            <div class="blog-content">
                                <ul class="blog-meta">
                                    <li><i class="fas fa-user"></i><span>admin</span></li>
            ...
            <div class="col-md-7 col-lg-4">
                ...
                <div class="blog-widget">
                    ...
                    <ul class="blog-widget-feed">
                        <li><a class="blog-widget-media" href="#"><img src="images/blog-widget/01.jpg"
                                    alt="blog-widget"></a>
                            <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet
                                    consectetur</a><span>february 02, 2021</span></h6>
                        </li>
                        <li><a class="blog-widget-media" href="#"><img src="images/blog-widget/02.jpg"
                                    alt="blog-widget"></a>
                            <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet
                                    consectetur</a><span>february 02, 2021</span></h6>
                        </li>
                        <li><a class="blog-widget-media" href="#"><img src="images/blog-widget/03.jpg"
                                    alt="blog-widget"></a>
                            <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet
                                    consectetur</a><span>february 02, 2021</span></h6>
                        </li>
                        <li><a class="blog-widget-media" href="#"><img src="images/blog-widget/04.jpg"
                                    alt="blog-widget"></a>
                            <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet
                                    consectetur</a><span>february 02, 2021</span></h6>
                        </li>
                        <li><a class="blog-widget-media" href="#"><img src="images/blog-widget/05.jpg"
                                    alt="blog-widget"></a>
                            <h6 class="blog-widget-text"><a href="#">Lorem ipsum dolor sit amet
                                    consectetur</a><span>february 02, 2021</span></h6>
                        </li>
