...
<section class="inner-section">
    <div class="container">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5 justify-content-center">
            <div class="col">
                <div class="category-wrap">
                    <div class="category-media"><img src="images/category/dairy.jpg" alt="category">
                        <div class="category-overlay"><a href="shop-3column.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
            ...
            <div class="col">
                <div class="category-wrap">
                    <div class="category-media"><img src="images/category/fruits.jpg" alt="category">
                        <div class="category-overlay"><a href="shop-3column.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                    <div class="category-meta">
            ...
            <div class="col">
                <div class="category-wrap">
                    <div class="category-media"><img src="images/category/seafoods.jpg" alt="category">
                        <div class="category-overlay"><a href="shop-3column.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                    <div class="category-meta">
            ...
            <div class="col">
                <div class="category-wrap">
                    <div class="category-media"><img src="images/category/fastfoods.jpg" alt="category">
                        <div class="category-overlay"><a href="shop-3column.html"><i class="fas fa-link"></i></a>
                        </div>
                    </div>
                    <div class="category-meta">
