...
<section class="inner-section">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="product-grid"><img src="images/product/01.jpg" alt="product"><img
                        src="images/product/01.jpg" alt="product"><img src="images/product/01.jpg"
                        alt="product"><img src="images/product/01.jpg" alt="product"></div>
            </div>
            <div class="col-lg-6">
